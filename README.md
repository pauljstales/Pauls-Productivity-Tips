...
2. **Worst Thing First, then the Bare Minimum**: Do the thing you dread doing the most, FIRST, and just get it out of the way (sometimes called "eat the frog")... and then do the absolute bare minimum list of things that must be done
...
7. **Acting/Applying**: Do the worst thing first, then "one task at a time", do the bare minimum list of goals for the day, then work as best you can for the remainder "again, one task at a time"; if any fires pop up, put them out and fireproof the situation, and remember - only deliveries count
